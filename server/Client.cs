...
namespace VoxelLegacyGameServer
{
    class Client
    {
        ...
        public class TCP//store the tcp intis callback
        {
            ...
            public void SendData(Packet _packet)
            {
                ...
                {
                    Console.WriteLine($"Error failed to send data to {id} via TCP: {_ex}");
                }
            }
            ...
            private void RecieveCallBack(IAsyncResult _result)
            {
                try
                {
                    ...
                    Array.Copy(recieveBuffer, _data, _byteLengh);
        ...
        public class UDP
        {
            ...
            {
                int packetLenth = _packetData.ReadInt();
                byte[] _packetBytes = _packetData.ReadBytes(packetLenth);
